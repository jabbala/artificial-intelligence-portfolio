...
## Table of Contents
* Project 1: Sudoku Solver AI Agent
...
* Project 8: AI Agent for Doom using Deep Convolutional Q-learning
* Project 9: Maximizing Revenue of an Online Retail Business through Thompson Sampling
* Project 10: AI Agent for Breakout using Asynchronous Actor-Critic Agents (A3C)

## Portfolio Highlights

### 1. Sudoku Solver AI Agent
...
### 3. Adversarial Game Playing Agent
...
### 4. Parts of Speech Tagging with AI
...
### 5. Finding Shortest Paths on a Planet using Genetic Algorithm
